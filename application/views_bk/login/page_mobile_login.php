...
-->
	...
	<div style="position: absolute; top: 10%; left: 10%; width: 80%; overflow:hidden;">
		<img src="<?php echo base_url()?>/images/login/signin-logo.png" width="100%"  />
		<table border=0 cellpadding=0 cellspacing=0 width=100%>
			<tr>
				<td align="center" id="login_page_description1" style="font-size: 150%; width: 100%;" colspan=3>
					Sign in with any of these services for free
				</td>
			</tr>
			<tr><td align=left width="33%" valign=top>
					...
					<img src="<?php echo base_url()?>/images/login/button-facebook.png" width=100%  onclick="submit_openid('facebook')" />
			</td><td align=right width="33%" valign=top>
					<!--
