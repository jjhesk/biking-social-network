	<div style="float:left; width:676px; background-color:#DDDDDD; color:#808080; border:1px #ABABAB solid;">
		<div style="float:left; margin-top:8px; margin-left:15px;">Recent Activities</div>
		
		<div class="index_round_corners" style="position:relative; background-color:#FFFFFF; margin-top:35px; margin-left:10px; margin-bottom:10px; width:658px; height: 270px; overflow-y: auto">
