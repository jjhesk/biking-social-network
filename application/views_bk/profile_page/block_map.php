...
<style>
	...
	<div class="block_map index_block_shadow" style="position:relative; float:left;">
		<div class="index_block_c_header" >
			<p style="padding:8px">Activity Map<a id="index_title" class="nyroModal nyro_icon" href="<?=site_url()?>/profile_page/nyro_recent_activities_map/<? echo $activity_id?>"></a></p>
		</div>
