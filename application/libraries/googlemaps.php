...
class Googlemaps {
	...
	function create_map()
	{
		...
		'; }
		/*if ($this->center=="auto" || $this->directionsStart=="auto") { $this->output_js .= '
		<script type="text/javascript" src="'.base_url().'/js/gears_init.js"></script>
		...
		if ($this->kmlLayerURL!="") {
			//echo "<br/>google map 1306 ".$this->kmlLayerURL;
			$this->output_js_contents .= '
				var kmlLayerOptions = {
					map: '.$this->map_name;
