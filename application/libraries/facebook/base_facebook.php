...
abstract class BaseFacebook
{
  ...
  public function getAccessToken() {
    if ($this->accessToken !== null) {
      ...
      //echo "<br/>base_facebook 343 ".$this->accessToken;
    ...
    //$this->setAccessToken($this->getUserAccessToken());
      ...
      if (isset($_REQUEST['signed_request'])) {
        ...
        $this->signedRequest = $this->parseSignedRequest(
          $_COOKIE[$this->getSignedRequestCookieName()]);
      		...
      		$this->signedRequest = $this->parseSignedRequest($_REQUEST['session']);
			echo "<br/>base_facebook 442";
			print_r($this->signedRequest );
      }
    }
  ...
  public function getLoginUrl($params=array(), $currentUrl='') {
	...
	return $this->getUrl('www', 'dialog/oauth', $params);
	//rewrite because array_merge warning
    /*return $this->getUrl(
      'www',
      'dialog/oauth',
      array_merge(array(
